...
export default function Page() {
  ...
  useEffect(() => {
    // Replace this URL with your Azure Function URL when ready
    axios.get('https://example.azurewebsites.net/api/emissions')
      ...
      .catch((error) => {
        ...
        // Fallback mock data
        setEmissionsData([
          { name: 'VM Hours', value: 150 },
          { name: 'Storage GB', value: 600 },
        ]);
      });
  }, []);
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-8">
      ...
      <p className="mt-8 text-sm text-gray-500">
        Visualizing estimated carbon emissions from cloud usage.
      </p>
    </main>
  );
}
